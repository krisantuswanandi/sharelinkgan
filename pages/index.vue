...
<template>
  <div class="flex flex-col h-full">
    <nav
      class="flex justify-between items-center px-4 py-3 bg-neutral-900 border-b border-neutral-700/70"
    >
      <div class="flex items-center">
        <img
          src="/logo.svg"
          alt="Sharelinkgan"
          class="w-8 mr-2 p-0.5 bg-gray-400 rounded-full"
        />
      ...
      <div class="flex items-center">
        ...
        <button
          class="ml-1 flex justify-center items-center w-8 h-8 hover:bg-neutral-800 rounded"
    ...
    <div class="flex flex-1 overflow-hidden">
      ...
      <Transition name="slide">
        <div v-if="sidebarOpen" class="fixed top-0 right-0 w-96 h-full z-40">
          ...
          >
            <div class="mt-2">
              <div class="font-bold tracking-wider text-xs text-neutral-600">
                URL SHORTENER
              </div>
              <div class="mt-2 h-16">
                <button
            ...
            <div class="mt-2">
              ...
              <ClientOnly>
                ...
                <div
                  v-else
                  class="mt-12 text-center text-neutral-300/10 font-italic text-sm"
                >
                  No saved URLs
                </div>
              </ClientOnly>
